(function () {
    ...
    window.__QUIZ_VARIANTS["variant3"] = [
        ...
        },
        {
            ...
            options: ["Логтау өшіріледі", "Логтау жадыда жүзеге асады", "Логтар автоматты түрде файлға жіберіледі", "Логтар әдепкі бойынша консольге жазылады"],
            correctAnswer: "Логтау өшіріледі",
        },
        {
